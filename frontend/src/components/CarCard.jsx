...
// //   const getImageUrl = (type) => {
// //     switch (type) {
// //       case "SUV": return "https://i.pinimg.com/474x/0f/c8/36/0fc836701d156f6e42595709d7773b44.jpg";
// //       case "Sedan": return "https://i.pinimg.com/474x/fd/52/67/fd5267988393235258b7b32763b67d05.jpg";
// //       case "Luxury": return "https://i.pinimg.com/474x/c5/72/49/c572495a735f8c9a42c9419524c90b23.jpg";
// //       case "Hatchback": return "https://i.pinimg.com/474x/7a/3e/ba/7a3eba674c45f37f174582532d2671ed.jpg";
// //       default: return "https://i.pinimg.com/474x/0f/c8/36/0fc836701d156f6e42595709d7773b44.jpg";
// //     }
// //   };
...
// //             <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-3 sm:mb-4">
// //               <div className="sm:w-1/3">
// //                 <img src={getImageUrl(car.type)} alt={car.model} className="w-full h-32 sm:h-40 object-contain rounded-lg bg-gray-50 p-2" />
// //               </div>
// //               <div className="sm:w-2/3 flex flex-col justify-between">
// //                 <div className="grid grid-cols-2 gap-2 sm:gap-4">
// //                   <div className="flex items-center space-x-2 text-gray-600">
...
// //                   {carAgencies[`${car.make}-${car.model}`].map((deal) => (
...
// //                       </div>
// //                       <button
// //                         onClick={() => navigate("/car-confirmation", { state: { ...location.state, car, selectedDeal } })}
...
// const CarCard = ({ cars, initialState }) => {
//   const navigate = useNavigate();
//   const [expandedCarId, setExpandedCarId] = useState(null);
...
//       state: {
//         ...initialState, // Use the initial state passed as props
//         car,
//         selectedDeal: deal,
//       },
//     });
