  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto max-w-7xl px-4 py-6 sm:py-8">
        ...
        {/* <div className="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-2 gap-4 sm:gap-7">
        <div className="bg-blue-500  px-2 py-1 rounded-md border-blue-500">
          <button  className="text-lg font-bold width-200 text-white ">Recommended</button>
         </div>
        </div> */}
