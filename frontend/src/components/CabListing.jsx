...
//     const [cars, setCars] = useState([]);  // Stores the fetched car listings

//   // Fetch car data from backend
//   useEffect(() => {
//     fetch("https://your-backend-api.com/cars")  // Replace with actual API URL
//       .then((res) => res.json())
...
//       (!filters.luggage || car.luggage === filters.luggage)
//     );
//   });
...
//     {/* Sidebar for Filters */}
//     <div className="w-1/4 p-4 bg-[#06152B] shadow-md rounded-md">
...
//         {/* Luggage Capacity */}
//         <div className="mb-4">
//           <label className="block font-medium mb-1">Luggage Capacity:</label>
//           {["Barrier", "No Barrier"].map((option) => (
//             <label key={option} className="flex items-center space-x-2">
//               <input
//                 type="checkbox"
//                 value={option}
//                 onChange={(e) => handleCheckboxChange(e, "luggageCapacity")}
//                 checked={filters.luggageCapacity.includes(option)}
//               />
//               <span>{option}</span>
//             </label>
//           ))}
...
//                 </h3>
//                 <p className="text-sm text-gray-500">{car.type} • {car.fuelType} • {car.mileage} km/l</p>
//                 <p className="text-sm text-gray-700">Agency: {car.carAgency}</p>
//                 <p className="text-green-600 font-semibold mt-1">
//                   ₹ {car.pricePerDay}/day <span className="text-gray-500 text-sm">(Agency Price: ₹{car.agencyPrice})</span>
//                 </p>
...
const CabListing = () => {
  ...
  return (
    <div className="min-h-screen text-white bg-gray-100">
      ...
      {/* Page Content with Padding to Avoid Overlapping Sticky Bar */}
      <div className=" flex">
        {/* Sidebar for Filters */}
        <div className="w-1/4 p-4 bg-[#06152B] shadow-md rounded-md">
          <h2 className="text-xl font-semibold mb-4">Select Filters</h2>
